...
export default function App() {
  ...
  const handleRazorpayPayment = async () => {
    alert("Payment gateway will be activated after live approval.");
  };
          ...
          <div className="fixed top-0 right-0 w-full sm:w-[400px] h-full bg-white/90 backdrop-blur-lg shadow-lg z-50 border-l border-gray-200 transition-transform duration-300">
            ...
            <div className="p-4 border-t bg-white">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-pink-500 to-purple-500 text-white font-semibold py-3 rounded-lg "
        ...
        <main className="flex-grow">
          <Routes>
            ...
            <Route
              ...
              element={<Categories categories={categories} cartContext={cartContext} />}
            />
            {/* <Route path="/categories/:categoryId" element={<Categories cartContext={cartContext} />} /> */}
